        ...
        <form onSubmit={handleSubmit} className="create-orphanage-form">
          <fieldset>
            ...
            <div className="input-block">
              ...
              {previewImages.map(image=><img key={image} src={image} alt={nameInputRef.current?.value}/>)}
                <label htmlFor="image[]" className="new-image">
                  <FiPlus size={24} color="#15b6d6" />
                </label>
                
              </div>
              <input ref={imagesInputRef} onChange={handleSelectedImages} multiple type="file" name="" id="image[]"/>
